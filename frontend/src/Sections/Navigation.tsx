...
export default function Navigation() {
  ...
  return (
    <div id='my-learning' className='flex  w-full min-h-screen pt-6 bg-[#FCF1CC]'>
        ...
        <div className="container w-full h-screen bg-white rounded-2xl lg:p-8 shadow-md shadow-gray-300">
            <Outlet />
        </div>
    </div>
  )
