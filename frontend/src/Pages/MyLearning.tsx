...
const MyLearning: React.FC = () => {
    const [lessons, setLessons] = useState<Lesson[] | unknown[]>([]);
        ...
        const fetchedLessons = [
            {
                ...
                subject: 'Physics',
                tasks: [{ id: 1, title: 'Start reading', type: "reading", url: '#', progress: 100 }],
            },
            {
                id: 2,
                ...
                subject: 'Math',
                tasks: [
                    { id: 1, title: 'Reading: Functions - Chapter 2', type: 'reading', url: '#', progress: 50 },
                    { id: 2, title: 'Video Lecture: Understanding Functions', type: 'video', url: '#', progress: 0 },
            ...
            },
            {
                ...
                subject: 'Math',
                tasks: [{ id: 1, title: 'Some quiz', type: 'quiz', url: '#', progress: 100 }],
            },
        ];
