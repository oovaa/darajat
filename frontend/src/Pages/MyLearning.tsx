...
interface Task {
    id: number;
    type: "video" | "quiz" | "reading" | "practice" | 'somthingElse';
    title: string;
    progress: number;
    url: string;
}
...
const MyLearning: React.FC = () => {
    ...
    useEffect(() => {
        const fetchedLessons = [
            { id: 1, title: 'Kinematics (Velocity & Acceleration)', subject: 'Physics', tasks: [{ id: 1, title: 'Start reading', type: "reading", url: '#', progress: 100 }] },
            {
                id: 2, title: 'Functions (Introduction & Types)', subject: 'Math', tasks: [
                    { id: 1, title: 'Reading: Fuctions - Chapter 2', type: 'reading', url: '#', progress: 50 },
                    { id: 2, title: 'Video Lecture: Understanding Fuctions', type: 'video', url: '#', progress: 0 },
                    { id: 3, title: 'Practice Problems', type: 'practice', url: '#', progress: 0 },
                ]
            },
            { id: 3, title: 'Reinforcement & Review: Mini Quiz', subject: 'Math', tasks: [{ id: 1, title: 'some quiz', type: 'quiz', url: '#', progress: 100 }] },
        ];
    ...
    return (
        <div id='my-learning' className='min-h-screen p-6 bg-[#FCF1CC]'>
            <div className="container lg:w-[94%] min-h-[90%] lg:ml-auto bg-white rounded-2xl p-4 lg:p-8 shadow-md shadow-gray-300">
                ...
                <div className='week flex flex-col-reverse lg:grid lg:grid-cols-12 gap-2 lg:gap-10'>
                    ...
                    <div className="notes col-span-4 grid grid-cols-2 lg:grid-cols-1 gap-2 lg:justify-items-end">
                        <div className='static-note lg:h-[160px] lg:w-[285px] my-3 shadow-md shadow-gray-400 py-3 bg-[#AFE9D9]'>
                            <h3 className="note-title text-xs lg:text-md font-bold px-3">Important Note</h3><hr className='my-1' />
